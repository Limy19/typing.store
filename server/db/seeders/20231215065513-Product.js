    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          name: 'SYLPH POTION',
          description:
            'Благодаря особому партнерству между Mochi Crafts, TKC и AKKO, мы с гордостью предлагаем ограниченную серию AKKO ACR Pro 75. Официальный комплект ограниченной серии Mochi включает полностью собранную, готовую к использованию клавиатуру прямо из коробки, со спецификациями. d точно так же, как использует Моти.',
          price: 300,
          meta: JSON.stringify({ size: 'full', color: 'pink' }),
          categoryId: 1,
          stock: 3,
        ...
        },
        {
          name: 'MONSGEEK M1',
          description:
            'MonsGeek M1 — лучший вариант премиум-класса, с которого можно начать путешествие по индивидуальной механической клавиатуре.Он поставляется с дополнительными тефлоновыми подушечками (на случай, если вы хотите использовать мод Force Break) и лентой (если вы хотите использовать мод Tape). M1 предлагает вам гибкость, позволяющую модифицировать его и сделать его по-настоящему вашим, а также предлагает отличные возможности использования специального пенопластового крепления и прокладки MonsGeek.',
          price: 150,
          meta: JSON.stringify({ size: 'tkl', color: 'white' }),
          categoryId: 1,
          stock: 3,
